...
function Content() {
    ...
    return (
        <Box p={10}>
            <Flex>
                <Flex align="center">
                    <Editable value={processName} fontSize={20}
                              onInput={(e: any) => setProcessName(e.target.value)}>
                        <EditablePreview/>
                        <EditableInput/>
                    </Editable>
                </Flex>
                ...
                <Box ml={'auto'}>
                    <Menu>
                        <MenuButton as={Button} padding={6} rightIcon={<ChevronDownIcon/>}>
                            Предложить статусы
                        </MenuButton>
                        <MenuList>
                            <Button onClick={splitTask} width={'100%'} colorScheme='blue' isLoading={loadingSubTasks}>Создать
                                предложения</Button>
                ...
                <Flex ml={6}>
                    <Button size={'lg'} ml={"auto"} width={200} colorScheme='green' onClick={createProcess}>
                        Сохранить
                    </Button>
                </Flex>
            </Flex>
            <Box mt={6}>
                <Heading as='h1' size='md' mb={4}>Выбор цепочки статусов</Heading>
            ...
            <Flex justify={'space-between'}>
                <Box>
                    ...
                    <Card mt={6}>
                        ...
                        <CardBody>
                            <Stack divider={<StackDivider/>} spacing='4' height={190} width={350} overflow={'auto'}>
                                {
